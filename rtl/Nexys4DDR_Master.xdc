...
## Clock signal
set_property -dict { PACKAGE_PIN E3    IOSTANDARD LVCMOS33 } [get_ports { clk_AES }]; #IO_L12P_T1_MRCC_35 Sch=clk100mhz
...
set_property -dict { PACKAGE_PIN J15   IOSTANDARD LVCMOS33 } [get_ports { AES_dir }]; #IO_L24N_T3_RS0_15 Sch=sw[0]
set_property -dict { PACKAGE_PIN L16   IOSTANDARD LVCMOS33 } [get_ports { enable_AES }]; #IO_L3N_T0_DQS_EMCCLK_14 Sch=sw[1]
...
set_property -dict { PACKAGE_PIN V11   IOSTANDARD LVCMOS33 } [get_ports { AES_ready }]; #IO_L21N_T3_DQS_A06_D22_14 Sch=led[15]
...
set_property -dict { PACKAGE_PIN M17   IOSTANDARD LVCMOS33 } [get_ports { rstn_AES }]; #IO_L10N_T1_D15_14 Sch=btnr
